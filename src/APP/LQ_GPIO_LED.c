...
void LED_Ctrl(LEDn_e LEDno, LEDs_e sta)
{
    ...
    case LEDSYS:
      if(sta==ON)        PIN_Write(LEDSp,0);
      else if(sta==OFF) PIN_Write(LEDSp,1);
      else if(sta==RVS) PIN_Reverse(LEDSp);
    break;

    case LEDBUZ:
      if(sta==ON)        PIN_Write(LEDBp,0);
      else if(sta==OFF) PIN_Write(LEDBp,1);
      else if(sta==RVS) PIN_Reverse(LEDBp);
    break;
