...
void RGB_Init(void)
{
    ...
    PIN_InitConfig(P13_1,PIN_MODE_OUTPUT,0);
...
uint32_t RGB_SetColorToColor(unsigned long color0, unsigned long color1)
{
	...
	// 绿 红 蓝 三原色分解
	Red0   = (unsigned char)(color0>>8);
	Green0 = (unsigned char)(color0>>16);
	Blue0  = (unsigned char)(color0);
	
	Red1   = (unsigned char)(color1>>8);
	Green1 =(unsigned char) (color1>>16);
	Blue1  = (unsigned char)(color1);
